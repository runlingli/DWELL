...
// Initial mock data for development and testing
...
export const INITIAL_LISTINGS: Listing[] = [
  {
    ...
    additionalImages: ['https://images.unsplash.com/photo-1484154218962-a197022b5858?q=80&w=1000'],
    description:
      'Steps away from the UC Davis Arboretum. A minimalist haven with natural light and proximity to the vibrant downtown scene.',
    bedrooms: 2,
    bathrooms: 1,
  ...
  },
  {
    ...
    additionalImages: ['https://images.unsplash.com/photo-1556912177-c54030639a6d?q=80&w=1000'],
    description:
      'Modern lines meet suburban quietude. This loft features double-height ceilings and easy access to the greenbelt.',
    bedrooms: 2,
    bathrooms: 2,
  ...
  },
  {
    ...
    type: 'Studio',
    imageUrl:
      'https://plus.unsplash.com/premium_photo-1676968002512-3eac82b1d847?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D?q=80&w=2000&auto=format&fit=crop',
    description:
      'A stark, beautiful studio designed for the dedicated academic. Quiet, refined, and perfectly positioned near campus.',
    bedrooms: 0,
    bathrooms: 1,
  ...
  },
  {
    ...
    coordinates: { lat: 38.575, lng: -121.71 },
    radius: 500,
    type: 'House',
    imageUrl:
      'https://images.unsplash.com/photo-1512917774080-9991f1c4c750?q=80&w=2000&auto=format&fit=crop',
    description:
      'Expansive living on the edge of the city. Unobstructed views of the surrounding valley and uncompromising modern architecture.',
    bedrooms: 4,
    bathrooms: 3,
