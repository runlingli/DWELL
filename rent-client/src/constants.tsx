...
export const INITIAL_LISTINGS: Listing[] = [
  ...
  },
  {
    ...
    radius: 250,
    type: 'Studio',
    imageUrl: 'https://images.unsplash.com/photo-1536376074432-bf12177448b3?q=80&w=2000&auto=format&fit=crop',
