  ...
  return (
    <div className="group relative border-b border-[#4a586e]/10 pb-8 mb-8 last:border-0 last:mb-0 lg:border-0 lg:pb-0 lg:mb-0 cursor-pointer">
      ...
      <div className="mt-6 flex justify-between items-start" onClick={() => onClick(listing)}>
        <div>
          <h3 className="font-serif text-xl mb-1 text-[#4a586e] group-hover:underline underline-offset-4 decoration-1 tracking-tight">
            {listing.title}
          </h3>
          <p className="text-[#7e918b] text-[10px] uppercase tracking-widest font-bold">
      ...
      <div
        className="mt-4 flex gap-4 text-[9px] uppercase tracking-widest text-[#4a586e]/60 border-t border-[#4a586e]/10 pt-4"
        onClick={() => onClick(listing)}
      >
